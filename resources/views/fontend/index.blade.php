        ...
        <header class="rn-header-area d-flex align-items-start flex-column left-header-style">
            <div class="logo-area">
                <a href="index.html">
                    ...
                    <img src="{{asset('fontend/assets/images/logo/logo-07.png')}}" alt="personal-logo">
                </a>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="banner-inner text-center">
                            <h1 class="fs--100">KRISTINA SMOLYER</h1>
                            <!-- type headline start-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-area text-center">
                            ...
                            <p class="description mt--30">© 2022. All rights reserved by <a target="_blank" href="https://themeforest.net/user/rainbow-themes/portfolio">Personal portifolio</a></p>
                        </div>
                    </div>
                </div>
            </div>

...
<!-- Mirrored from rainbowit.net/html/inbio/index-white-version.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Nov 2022 21:50:14 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('fontend/assets/css/vendor/slick.css')}}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/css/vendor/slick-theme.css')}}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/css/vendor/aos.css')}}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/css/plugins/feature.css')}}">
    <!-- Style css -->
...
<body class="template-color-1 spybody white-version" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
        ...
        <div class="header-wrapper rn-popup-mobile-menu m--0 row align-items-center">
            ...
            <div class="col-lg-2 col-6">
                <div class="header-left">
                    <div class="logo">
                        <a href="index.html">
                            <img src="{{asset('fontend/assets/images/logo/logo-dark.png')}}" alt="logo">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-top">
                <div class="menu-header">
                    <a class="logo" href="index.html">
                        <img src="{{asset('fontend/assets/images/logo/logos-circle.png')}}" alt="Personal Portfolio">
                    </a>
                ...
                <div class="container">
                    <div class="row row--30 align-items-center">
                                    ...
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12 mt_mobile--30">
                                        <div class="skill-share-inner">
                                            ...
                                            <ul class="skill-share d-flex liststyle">
                                                <li><img src="{{asset('fontend/assets/images/icons/icons-01.png')}}" alt="Icons Images"></li>
                                                <li><img src="{{asset('fontend/assets/images/icons/icons-02.png')}}" alt="Icons Images"></li>
                                                <li><img src="{{asset('fontend/assets/images/icons/icons-03.png')}}" alt="Icons Images"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="order-1 order-lg-2 col-lg-5">
                            <div class="thumbnail">
                                <div class="inner">
                                    <img src="{{asset('fontend/assets/images/slider/banner-01.png')}}" alt="Personal Portfolio Images">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('fontend/assets/images/portfolio/portfolio-01.jpg')}}" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('fontend/assets/images/portfolio/portfolio-02.jpg')}}" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('fontend/assets/images/portfolio/portfolio-03.jpg')}}" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('fontend/assets/images/portfolio/portfolio-04.jpg')}}" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('fontend/assets/images/portfolio/portfolio-05.jpg')}}" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('fontend/assets/images/portfolio/portfolio-06.jpg')}}" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                        ...
                        <div class="testimonial-activation testimonial-pb mb--30">
                                ...
                                <div class="inner">
                                    <div class="card-info">
                                        <div class="card-thumbnail">
                                            <img src="{{asset('fontend/assets/images/testimonial/final-home--1st.png')}}" alt="Testimonial-image">
                                        </div>
                                    ...
                                    <div class="card-description">
                                        <div class="title-area">
                                            ...
                                            <div class="rating">
                                                <img src="{{asset('fontend/assets/images/icons/rating.png')}}" alt="rating-image">
                                                <img src="{{asset('fontend/assets/images/icons/rating.png')}}" alt="rating-image">
                                                <img src="{{asset('fontend/assets/images/icons/rating.png')}}" alt="rating-image">
                                                <img src="{{asset('fontend/assets/images/icons/rating.png')}}" alt="rating-image">
                                                <img src="{{asset('fontend/assets/images/icons/rating.png')}}" alt="rating-image">
                            ...
                            <div class="testimonial mt--50 mt_md--40 mt_sm--40">
                                <div class="inner">
                                    <div class="card-info">
                                        <div class="card-thumbnail">
                                            <img src="{{asset('fontend/assets/images/testimonial/final-home--2nd.png')}}" alt="Testimonial-image">
                                        </div>
                                        <div class="card-content">
                            ...
                            <div class="testimonial mt--50 mt_md--40 mt_sm--40">
                                <div class="inner">
                                    <div class="card-info">
                                        <div class="card-thumbnail">
                                            <img src="{{asset('fontend/assets/images/testimonial/final-home--3rd.png')}}" alt="Testimonial-image">
                                        </div>
                                        <div class="card-content">
                            ...
                            <div class="testimonial mt--50 mt_md--40 mt_sm--40">
                                <div class="inner">
                                    <div class="card-info">
                                        <div class="card-thumbnail">
                                            <img src="{{asset('fontend/assets/images/testimonial/final-home--4th.png')}}" alt="Testimonial-image">
                                        </div>
                                        <div class="card-content">
                            ...
                            <div class="testimonial mt--50 mt_md--40 mt_sm--40">
                                <div class="inner">
                                    <div class="card-info">
                                        <div class="card-thumbnail">
                                            <img src="{{asset('fontend/assets/images/testimonial/final-home--5th.png')}}" alt="Testimonial-image">
                                        </div>
                                        <div class="card-content">
                                        ...
                                        <div class="client-card">
                                            ...
                                            <div class="main-content">
                                                <div class="inner text-center">
                                                    <div class="thumbnail">
                                                        <a href="#"><img src="{{asset('fontend/assets/images/client/png/brand-01.png')}}" alt="Client-image"></a>
                                                    </div>
                                                    <div class="seperator"></div>
                                            ...
                                            <div class="main-content">
                                                <div class="inner text-center">
                                                    <div class="thumbnail">
                                                        <a href="#"><img src="{{asset('fontend/assets/images/client/png/brand-02.png')}}" alt="Client-image"></a>
                                                    </div>
                                                    <div class="seperator"></div>
                                            ...
                                            <div class="main-content">
                                                <div class="inner text-center">
                                                    <div class="thumbnail">
                                                        <a href="#"><img src="{{asset('fontend/assets/images/client/png/brand-03.png')}}" alt="Client-image"></a>
                                                    </div>
                                                    <div class="seperator"></div>
                                            ...
                                            <div class="main-content">
                                                <div class="inner text-center">
                                                    <div class="thumbnail">
                                                        <a href="#"><img src="{{asset('fontend/assets/images/client/png/brand-04.png')}}" alt="Client-image"></a>
                                                    </div>
                                                    <div class="seperator"></div>
                                            ...
                                            <div class="main-content">
                                                <div class="inner text-center">
                                                    <div class="thumbnail">
                                                        <a href="#"><img src="{{asset('fontend/assets/images/client/png/brand-05.png')}}" alt="Client-image"></a>
                                                    </div>
                                                    <div class="seperator"></div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 mt--30 col-md-6 col-sm-12 col-12 mt--30">
                        <div class="rn-blog" data-bs-toggle="modal" data-bs-target="#exampleModalCenters">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('fontend/assets/images/blog/blog-01.jpg')}}" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="150" data-aos-once="true" class="col-lg-6 col-xl-4 mt--30 col-md-6 col-sm-12 col-12 mt--30">
                        <div class="rn-blog" data-bs-toggle="modal" data-bs-target="#exampleModalCenters">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('fontend/assets/images/blog/blog-02.jpg')}}" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="200" data-aos-once="true" class="col-lg-6 col-xl-4 mt--30 col-md-6 col-sm-12 col-12 mt--30">
                        <div class="rn-blog" data-bs-toggle="modal" data-bs-target="#exampleModalCenters">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('fontend/assets/images/blog/blog-03.jpg')}}" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                ...
                <div class="row mt--50 mt_md--40 mt_sm--40 mt-contact-sm">
                    <div class="col-lg-5">
                        <div class="contact-about-area">
                            <div class="thumbnail">
                                <img src="{{asset('fontend/assets/images/contact/contact1.png')}}" alt="contact-img">
                            </div>
                            <div class="title-area">
        ...
        <div class="modal fade" id="exampleModalCenters" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-news" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="{{asset('fontend/assets/images/blog/blog-big-01.jpg')}}" alt="news modal" class="img-fluid modal-feat-img">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{asset('fontend/assets/images/logo/logo-vertical-dark.png')}}" alt="logo">
                            </a>
                        </div>
    ...
    <!-- JS ============================================ -->
    <script src="{{asset('fontend/assets/js/vendor/jquery.js')}}"></script>
    <script src="{{asset('fontend/assets/js/vendor/modernizer.min.js')}}"></script>
    <script src="{{asset('fontend/assets/js/vendor/feather.min.js')}}"></script>
    <script src="{{asset('fontend/assets/js/vendor/slick.min.js')}}"></script>
    <script src="{{asset('fontend/assets/js/vendor/bootstrap.js')}}"></script>
    <script src="{{asset('fontend/assets/js/vendor/text-type.js')}}"></script>
    <script src="{{asset('fontend/assets/js/vendor/wow.js')}}"></script>
    <script src="{{asset('fontend/assets/js/vendor/aos.js')}}"></script>
    <script src="{{asset('fontend/assets/js/vendor/particles.js')}}"></script>
    <script src="{{asset('fontend/assets/js/vendor/jquery-one-page-nav.js')}}"></script>
    <!-- main JS -->

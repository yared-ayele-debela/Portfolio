           ...
           <div class="card">
              <div class="card-body">
                 ...
                 <ul class="nav pb-5 nav-tabs align-items-end card-header-tabs w-100">
                  <li class="nav-item">
                    <a class="nav-link active" href"><i class="fa fa-list mr-2"></i>Add Services</a>
                  </li>
                    <li class="nav-item border-none">
                    <a class="nav-link bg-light " href="{{ route('allservice') }}"><i class=" fas fa-plus"></i>All Services</a>
                  </li>
                 </ul>
                  ...
                  @csrf
                    ...
                    <div class="row mb-3">
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-10 "> 
                        <textarea class="form-control" name="service_description" id="" cols="40" rows="10"></textarea>
